...
export default function VendorCompanyProfile() {
  ...
  return (
    <div className="relative py-10 md:pt-6 md:pb-0 border-t border-newborder border-solid lg:overflow-hidden">
          ...
          <div className="relative flex flex-wrap py-6 w-full">
            <div className="w-[34%] lg:w-full">
              <div className="sticky top-[10px] bg-white rounded-[12px] shadow-[0px_4px_15px_0px_rgba(0,0,0,0.05)] p-6 md:p-0 md:shadow-none">
                ...
                <h2 className="text-center text-[36px] text-gray-900 lg:text-[30px] md:text-[24px]">
                  Health Life
                </h2>
