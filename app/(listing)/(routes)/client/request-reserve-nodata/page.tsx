...
export default function RequestReserve() {
  ...
  return (
    <div className="relative py-10 md:pt-0 md:pb-0 border-t border-newborder border-solid">
      <div className="relative py-4 hidden md:pb-6 md:mb-6 md:flex md:justify-center md:border-b md:border-gray-200 md:border-solid">
        <a
          href="#"
          className="md:inline-flex items-center justify-center transition-all text-base text-primary font-satoshi_medium hover:opacity-50 hidden"
        >
          <i className="pr-4">
            <ArrowBackIcon />
          </i>
