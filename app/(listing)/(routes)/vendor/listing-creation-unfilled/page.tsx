...
import Availability from "@/components/CreateListingSteps_unfilled/Availability";
import FinishAndPublish from "@/components/CreateListingSteps_unfilled/FinishAndPublish";
import Location from "@/components/CreateListingSteps_unfilled/Location";
import Overview from "@/components/CreateListingSteps_unfilled/Overview";
import Photos from "@/components/CreateListingSteps_unfilled/Photos";
import Pricing from "@/components/CreateListingSteps_unfilled/Pricing";
import ThingsToKnow from "@/components/CreateListingSteps_unfilled/ThingsToKnow";
    ...
    <div className="pt-10 lg:pt-6 lg:overflow-hidden">
      ...
      <Container>
        <div className="flex relative justify-between lg:flex-wrap">
          ...
          <div className="w-[60%] xl:w-[67%] xl:mr-4 mr-8 lg:w-full lg:mr-0 lg:pt-4 md:pt-0">
        ...
        <div className="flex px-20 py-6 lg:px-0 lg:py-4 justify-end sticky bottom-0 bg-white md:flex-col-reverse md:pt-4 md:pb-8">
          <Button
            variant="ghost"
