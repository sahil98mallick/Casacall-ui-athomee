          ...
          <div className="w-[80%] lg:w-full">
            <div className="relative w-full">
              ...
              <div className="relative max-w-[660px] lg:max-w-full">
                <div className="flex flex-wrap mx-[-12px] mb-10 md:mb-6">
                  <div className="w-1/2 px-[12px] md:w-full">
                ...
                <div className="flex flex-wrap mx-[-12px] mb-10 md:mb-6">
                  <h2 className="w-full px-[12px] text-[20px] text-gray-900 font-satoshi_medium mb-3">
                    New password
                  </h2>
                  <div className="relative w-1/2 px-[12px] md:w-full md:mb-3">
                    <CustomInputWithLabel
                      label="New password"
                      value={"• • • • • • • • • • • • •"}
                    />
