        ...
        <div className="relative flex flex-wrap">
            ...
            <div className="sticky top-[40px] lg:relative lg:top-0 lg:border-b lg:border-solid lg:border-gray-200 md:min-w-[530px] lg:pb-1">
              <ul className="lg:flex items-center">
                <li className="pb-5 lg:pb-0 lg:pr-6">
                  <a
                    href="/profile/vendor/profile-settings/general"
                ...
                <li className="pb-5 lg:pb-0 lg:pr-6">
                  <a
                    href="/profile/vendor/profile-settings/password-security"
                    className="text-[16px] text-gray-400 font-satoshi_medium hover:text-gray-900"
                  >
                    Password & security
                  </a>
                ...
                <li className="pb-5 lg:pb-0 lg:pr-6">
                  <a
                    href="/profile/vendor/profile-settings/payment"
                    className="text-[16px] text-gray-400 font-satoshi_medium hover:text-gray-900"
                  >
                    Payment
                  </a>
                ...
                <li className="pb-5 lg:pb-0 lg:pr-6">
                  <a
                    href="/profile/vendor/profile-settings/notifications"
          ...
          <div className="w-[80%] lg:w-full">
            <div className="relative w-full">
              ...
              <div className="relative max-w-[660px] lg:max-w-full mb-12 pb-12  md:mb-6 md:pb-6 last:mb-0 border-[#E4E4E7] border-b last:border-0">
              ...
              <div className="relative max-w-[660px]  mb-12 pb-12 md:mb-6 md:pb-6 last:mb-0 border-[#E4E4E7] border-b last:border-0">
                <div className="mb-8 last:mb-0">
              ...
              <div className="relative max-w-[660px] pb-4 last:mb-0 border-[#E4E4E7] border-b last:border-0">
                <div className="mb-8 last:mb-0">
                  <h3 className="text-gray-900  text-xl mb-6">
                    SMS Notifications
                  </h3>
