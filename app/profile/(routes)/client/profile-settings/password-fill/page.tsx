          ...
          <div className="w-[80%] lg:w-full">
            <div className="relative w-full">
              ...
              <div className="relative max-w-[660px] lg:max-w-full">
                <div className="flex flex-wrap mx-[-12px] mb-10 md:mb-4">
                  <div className="w-1/2 md:w-full px-[12px]">
                ...
                <div className="flex flex-wrap mx-[-12px] mb-10 md:mb-4">
                  ...
                  <div className="relative w-1/2 md:w-full md:mb-3 px-[12px]">
                    <CustomInputWithLabel
                      label="New password"
                      value={"• • • • • • • • • • • • •"}
                    />
                ...
                <div className="relative flex justify-end pb-10 border-gray-200 border-b border-solid">
