                        ...
                        <div className="px-6 pt-6 h-[400px] overflow-y-auto">
                          ...
                          <div className="px-3 py-2 rounded-md bg-[#F5EFFD] max-w-[440px] ml-auto mb-4">
                            ...
                            <p className="text-base	text-gray-900">
                              ...
                              The 30-minute session is more focused on specific
                              areas, while the 60-minute session allows for a
                              more balanced approach, covering multiple areas.
                              The 90-minute session offers a thorough, full-body
                              massage with extra time to target specific
                              concerns.
                            </p>
                            <div className="flex justify-end items-center	pt-1">
                              <p className="text-xs	text-gray-400">5:50 PM</p>
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="bg-white">
                              <p>
                                ...
                                adipisicing elit. Dolorem, dolor.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
              ...
              <div className=" w-[60%] pr-8 border-r border-gray-100 md:w-full md:pr-0 md:border-0">
                ...
                <div className="flex items-center justify-between flex-wrap mb-4">
                  <div className="md:w-[60%]">
                    <h3 className="mb-1 sm:text-[20px]">Deep Tissue Massage</h3>
                    <p>30-Minute</p>
                  </div>
