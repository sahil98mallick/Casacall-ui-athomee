"use client";
import { PrimaryURL, baseUrlMedia, mediaURL } from "@/api/endpoints";
...
export default function Index() {
  ...
  const [individualvendorchatlists, setIndividualvendorchatlists] =
    useState<any>([]);
  ...
  const FetchVendorChatLists = async () => {
    ...
    chatlists(payload, {
      onSuccess: (response: any) => {
        ...
        setIndividualvendorchatlists(response?.data);
      },
      onError: () => {
  ...
  console.log("individualvendorchatlists", individualvendorchatlists);
            ...
            <div className="cmn_box p-6 rounded-xl border border-gray-50">
              ...
              <div className="py-5 border-b border-gray-100">
                ...
                <div className="flex flex-wrap items-center mt-2">
                  ...
                  {/* {UERDEATILS?.data?.data?.userVerificationFiles?.map(
                    (item: any, key: number) => {
                      console.log("baseUrlMedia:", baseUrlMedia);
                      console.log("item:", item);
                      return (
                        <>
                          <Badge className="rounded-[5px] border border-gray-200 py-1 px-2 bg-gray-50 text-gray-900 text-sm mr-2 mb-2">
              ...
              <Tabs defaultValue="services" className="w-full">
                <TabsList className="flex flex-wrap items-center justify-start mb-8">
                  ...
                  <TabsTrigger
                    ...
                    className="pb-5 text-base rounded-none mr-6 text-gray-900 sm:mb-2 sm:w-full sm:justify-start sm:pb-2"
                  >
                    Payouts
                  </TabsTrigger>
                  <TabsTrigger
                  ...
                  <TabsTrigger
                    ...
                    className="pb-5 text-base rounded-none  text-gray-900 sm:w-full sm:justify-start sm:pb-2"
                  >
                    Chat
              ...
              py-[6px] px-[10px] font-satoshi_medium text-sm`}
                ...
                <TabsContent value="chat">
                  <div className="flex border border-gray-200 rounded-lg">
                    <div className="w-full">
                      {individualvendorchatlists?.data?.length > 0 ? (
                        <>
                          <div
                          ...
                          >
                            {individualvendorchatlists?.data
                              ?.slice()
                              .reverse()
                              ?.map(
                                (item: ChatmessageDetails, index: number) => {
                                  return (
                                    <>
  ...
  /* <div className="w-1/3 px-4 sm:w-full sm:mb-3">
            <div className="cmn_box p-6 mb-8 rounded-xl border border-gray-50">
              ...
              <div className="relative flex flex-wrap items-center mb-6">
                ...
                <div className="relative">
                  <h5 className="text-[18px] font-satoshi_medium">Julia B.</h5>
                  <div className="flex items-center ">
                    <p className="text-[12px] font-satoshi_regular">4.6</p>
                    <StarRating totalStars={1} className="mx-1" />
                    <span className="text-gray-400 text-[12px]">(56)</span>
                  </div>
                </div>
              </div>
              <div className="pb-5 border-b border-gray-100">
            ...
            <div className="cmn_box p-6 rounded-xl border border-gray-50">
              ...
              <div className="pb-5 border-b border-gray-100">
                <p className="text-gray-500 text-sm">Registration Date</p>
                <h4 className=" text-base font-satoshi_medium">May 24, 2024</h4>
              </div>
              <div className="py-5 border-b border-gray-100">
                <p className="text-gray-500 text-sm">User Type</p>
                <h4 className=" text-base font-satoshi_medium">Client</h4>
              </div>
              <div className="py-5 border-b border-gray-100">
                <CommonSelect
                  labelPlaceholder="Commission rate"
              ...
              <div className="py-5 border-b border-gray-100 flex justify-between items-center">
                <div>
                  <p className="text-gray-500 text-sm">Status</p>
                  <h4 className=" text-base font-satoshi_medium">Active</h4>
                </div>
                <div className="flex items-center">
                  <Link
                    href="javascript:void(0)"
              ...
              <div className="py-5 border-b border-gray-100">
                <p className="text-gray-500 text-sm">Verification</p>
                <h4 className=" text-base font-satoshi_medium">Verified</h4>
                <div className="flex flex-wrap items-center mt-2">
                  <Badge className="rounded-[5px] border border-gray-200 py-1 px-2 bg-gray-50 text-gray-900 text-sm mr-2 mb-2">
                    <i className="flex items-center justify-center mr-2">
                      <Image
