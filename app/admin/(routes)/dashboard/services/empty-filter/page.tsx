    ...
    <div className="py-10 md:py-5">
      <Container>
        ...
        <Tabs defaultValue="all" className="w-full">
          <TabsList className="flex flex-wrap items-center justify-start mb-8 md:mb-2">
            <TabsTrigger
              value="all"
              className="pb-6 md:pb-3 text-base rounded-none mr-6 text-gray-900  sm:mb-2 sm:justify-start"
            >
              All&nbsp;<span className="text-sm text-gray-400">(0)</span>
            </TabsTrigger>
            ...
            <TabsTrigger
              ...
              className="pb-6 md:pb-3 text-base rounded-none  text-gray-900  sm:mb-2 sm:justify-start"
            >
              Company vendors&nbsp;
              <span className="text-sm text-gray-400">(0)</span>
            </TabsTrigger>
            ...
            <div>
              <div className="flex items-center flex-wrap mb-2">
                <PopOverComponent
                  label="Category"
                  className="mr-4"
                  classNameBtn="bg-primary text-white sm:w-full sm:mb-2"
                >
                  <div className="pb-[60px]">
                    ...
                    <div className="h-[300px] overflow-y-auto">
                      {select1?.map((item, index) => (
                        <>
                          {/* <SelectItem value={item?.mainText} key={index}> */}
                ...
                <PopOverComponent
                  ...
                  className="mr-4 sm:w-full sm:mb-2 sm:pr-0"
                >
                  <div>
          ...
          <TabsContent value="individual_vendors">
            <div>
              <div className="flex items-center flex-wrap mb-8">
                <PopOverComponent label="Category" className="mr-4">
                  <div className="pb-[60px]">
                    <div>
                      <SerachInputComponent className="mb-6" />
                    </div>
                ...
                <PopOverComponent label="Publication date" className="mr-4">
                  <div>
                    <div className="border-b border-solid pb-[24px] border-[#E4E4E7]">
                      <p className="text-primary text-base font-satoshi_medium mb-2.5">
                        By period
