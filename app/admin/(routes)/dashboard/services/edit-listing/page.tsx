        ...
        <div className="w-full pr-[32px] lg:w-full lg:pr-0">
          ...
          <div className="relative mb-10">
            ...
            <p className="text-[16px] font-satoshi_regular text-gray-800 mb-3">
              Experience the ultimate relaxation and relief with our Deep Tissue
              Massage service. Our skilled therapists use precise techniques to
              target deep layers of muscle tissue, releasing tension and
              promoting healing. Whether you&#39;re seeking relief from muscle
              pain or simply want to unwind, our Deep Tissue Massage is designed
            ...
            <p className="text-[16px] font-satoshi_regular text-gray-800 mb-3">
              ...
              specific needs. With a focus on providing a tranquil and soothing
              experience, our Deep Tissue Massage is the perfect choice for
              those looking to rejuvenate and refresh. Book your session now and
