...
export default function ProfileSignOutModalTw() {
  return (
    <div>
      <Dialog>
          ...
          <div className="relative pb-[80px] md:pb-0 md:basis-full md:flex md:flex-col">
            ...
            <h3 className="text-[16px] text-gray-900 font-satoshi_medium mb-1.5">
              ...
              <ul className="flex item-center">
                        <li className="relative pr-[20px] before:absolute before:w-[6px] before:h-[6px] before:rounded-full before:right-[8px] before:top-[10px] before:bg-gray-400"><p className="text-[14px] text-gray-400">Last activity yesterday </p></li>
                        <li><p className="text-[14px] text-gray-400">London, United Kingdom</p></li>
                    </ul>
            </div>
