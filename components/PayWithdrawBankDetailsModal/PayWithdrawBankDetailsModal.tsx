...
import NewCreditCardImgIcon from "@/json/icons/NewCreditCardImgIcon";
...
export default function PayWithdrawBankDetailsModal() {
  return (
    <div>
      <Dialog>
        <DialogTrigger asChild>
          <Button className="relative flex items-center justify-start bg-gray-50 w-full h-auto px-4 py-4 rounded-[8px] border-transparent border-solid border overflow-hidden hover:bg-[#F5EFFD] hover:border-gray-400">
            <i className="mr-4">
              <NewCreditCardImgIcon />
            </i>
            <p className="flex text-[20px] pr-1 text-gray-900 font-satoshi_medium leading-[1]">
              Bank account
            </p>
          </Button>
        </DialogTrigger>
