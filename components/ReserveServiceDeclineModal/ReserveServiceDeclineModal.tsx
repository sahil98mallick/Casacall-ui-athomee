...
export default function ReserveServiceDeclineModal() {
  return (
    <div>
      <Dialog>
        <DialogTrigger asChild>
          <Button
            variant="outline"
            className=" bg-[#F4F4F5] mt-2 border-0  hover:border-primary hover:text-primary hover:bg-gray-900 w-full text-gray-900 hover:text-white rounded-[100px] font-medium text-base"
          >
            Decline
          </Button>
        </DialogTrigger>
              ...
              <ul className="flex items-center md:w-full">
                ...
                <li className=" md:w-full">
                  <Button
                    type="button"
                    variant={"default"}
                    className="rounded-[50px] border-grey-200 px-[20px] py-[6px] transition-all bg-red-500 hover:bg-secondary hover:text-white md:w-full"
                  >
                    Decline reservation
                  </Button>
                </li>
