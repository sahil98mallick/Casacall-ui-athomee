...
import ImageIcon from "@/json/icons/ImageIcon";
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md !rounded-[12px]">
        ...
        <div className="relative md:basis-full md:flex md:flex-col">
          <div className="px-10 md:px-4 pt-6 pb-10 border-solid border-b border-gray-200 max-h-[494px] overflow-y-auto scrollbar scrollbar-thumb-[#F4F4F5] scrollbar-track-[#fff] scrollbar-thin md:basis-full">
            <div className="flex items-center justify-center border-[#7757BD] border-dashed border rounded-xl p-20 xl:p-10 md:p-5">
              <div className="text-center">
                ...
                <p className="text-xl mt-2 md:text-[18px]">
                  Drag & drop or{" "}
              ...
              <div className="bg-[var(--border-primary)] border border-solid border-[var(--greyF4F4F5)] rounded-[12px] p-4 relative pr-[60px] mt-6">
                ...
                <div className="flex flex-wrap">
                  ...
                  <div className="w-[calc(100%-48px)] pl-4 text-[var(--primary)]">
                    ...
                    <span className="text-sm text-[var(--textgray)]">6 MB</span>
                  </div>
                </div>
                <div className="mt-4">
                  <CommonProgress
          ...
          <div className="relative px-10 md:px-4 md:pt-4 md:pt-4 w-full pt-6 pb-2 bg-white  border-t border-solid flex justify-end items-center">
            <ul className="flex items-center md:w-full">
              ...
              <li className=" md:w-full">
                <Button type="button" variant={"default"} className="md:w-full">
                  Attach image
                </Button>
              </li>
            </ul>
