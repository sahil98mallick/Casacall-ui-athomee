...
const CustomCheckboxCategory = React.forwardRef<
  React.ElementRef<typeof CheckboxPrimitive.Root>,
  customCheckboxProps
>(
  (
    { className, children, icon, checked, value, handleChange, name, ...props },
    ref
  ) => (
...
CustomCheckboxCategory.displayName = CheckboxPrimitive.Root.displayName;

export { CustomCheckboxCategory };
