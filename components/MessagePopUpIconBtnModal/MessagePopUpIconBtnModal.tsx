...
export default function MessagePopUpIconBtnModal() {
  return (
    <div>
      <Dialog>
        ...
        <DialogContent className="sm:max-w-md !rounded-[12px]">
          <DialogHeader className="border-gray-200 border-solid border-b px-10 py-4">
            <DialogTitle className="text-[24px] md:text-[16px] text-left font-satoshi_medium m-0 sm:text-[14px] sm:leading-[1.5] md:!text-center">
              Contact the vendor
            </DialogTitle>
          </DialogHeader>
