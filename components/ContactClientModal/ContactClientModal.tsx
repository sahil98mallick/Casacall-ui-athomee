    ...
    <div>
      <Dialog>
        <DialogTrigger asChild>
          ...
          <Button
            variant="outline"
            className=" border-gray-200 hover:bg-primary hover:text-white"
          >
            Message
          </Button>
        </DialogTrigger>
        <DialogContent className="sm:max-w-md !rounded-[12px]">
          ...
          <div className="md:basis-full md:flex md:flex-col">
            <div className="px-10 pb-10 pt-6 border-solid sm:px-5 border-b border-gray-200  overflow-y-auto scrollbar scrollbar-thumb-[#F4F4F5] scrollbar-track-[#fff] scrollbar-thin md:basis-full">
