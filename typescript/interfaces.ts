...
export interface IReservationQueryParams {
  ...
  search?: string;
  status?: string[]; // Array of strings, as multiple statuses can be included
  vendor_type?: string[]; // Array of strings for vendor types
  category_id?: string[]; // Assuming this is an array of strings, given the context
  sub_category_id?: string[]; // Also an array of strings for sub-category IDs
  reservation_date?: {
...
interface ServiceData {
  ...
  booking_type: string;
  rules: any[]; // Could be further detailed if structure is known
...
export interface ServiceDataTwo {
  _id: string;
  user_id: string;
  vendor_data: VendorData;
  category_title: string;
